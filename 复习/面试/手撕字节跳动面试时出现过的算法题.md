-   [手撕字节跳动面试时出现过的算法题](#手撕字节跳动面试时出现过的算法题)
    -   [1.买股票的最佳时机](#买股票的最佳时机)
    -   [2.跳跃游戏](#跳跃游戏)
    -   [3.场景题：发红包](#场景题发红包)
    -   [4.合并排序的数组](#合并排序的数组)
    -   [5.剪绳子](#剪绳子)
    -   [6.有序数组中不重复元素的个数](#有序数组中不重复元素的个数)
    -   [7.找出不重复的元素个数](#找出不重复的元素个数)
    -   [8.找范围](#找范围)
    -   [9.测时间](#测时间)
    -   [10.链表相交](#链表相交)
    -   [11.求平方根](#求平方根)
    -   [12.场景题：互相关注表设计](#场景题互相关注表设计)
    -   [13.找 K 个最小值](#找-k-个最小值)
    -   [14.找出重复元素](#找出重复元素)
    -   [15.二叉树层次遍历](#二叉树层次遍历)
    -   [16.蛇形遍历二叉树](#蛇形遍历二叉树)
    -   [17.链表求和](#链表求和)
    -   [18.生成随机数](#生成随机数)
    -   [19.二叉树的最近公共祖先](#二叉树的最近公共祖先)
    -   [20.二叉树中的最大路径和](#二叉树中的最大路径和)
    -   [21.快速排序](#快速排序)
    -   [22.二叉树的前序遍历非递归](#二叉树的前序遍历非递归)
    -   [145.二叉树的后序遍历](#二叉树的后序遍历)
    -   [24.最长连续递增数列](#最长连续递增数列)
    -   [25.（智力题）海盗分金币](#智力题海盗分金币)
    -   [26.接雨水](#接雨水)
    -   [27. ip 判断](#ip-判断)
    -   [28. 二叉树的路径和](#二叉树的路径和)
    -   [29. 反转链表 + 每 k 个反转链表](#反转链表-每-k-个反转链表)
    -   [30. 场景题：求中位数](#场景题求中位数)
    -   [31. 螺旋矩阵](#螺旋矩阵)
    -   [32. 数据结构 heap](#数据结构-heap)
    -   [33. 中文数字转阿拉伯数字](#中文数字转阿拉伯数字)
    -   [34. 重建二叉树](#重建二叉树)
    -   [35. 路径总和](#路径总和)
    -   [36. 路径总和-2](#路径总和-2)
    -   [37. 单例模式](#单例模式)
    -   [38. 合并区间](#合并区间)
    -   [39. 翻转字符串中的单词](#翻转字符串中的单词)
    -   [40. 和为s的连续正整数序列](#和为s的连续正整数序列)
    -   [41. 二分查找](#二分查找)
    -   [42. 归并排序](#归并排序)
    -   [43. LRU 算法](#lru-算法)
    -   [44. 数据库连接池](#数据库连接池)
    -   [45. 版本数字比较](#版本数字比较)
    -   [46. 文件拷贝](#文件拷贝)
    -   [47. 场景题：redis 高并发](#场景题redis-高并发)
    -   [48. 最大栈](#最大栈)
    -   [49. 场景题：分布式生成数据](#场景题分布式生成数据)
    -   [50. B+树和红黑树（未完成）](#b树和红黑树未完成)
    -   [51. 找出和为 k 的数对](#找出和为-k-的数对)
    -   [52. 二叉树各层节点数](#二叉树各层节点数)
    -   [53. 输出下一个更大的数字](#输出下一个更大的数字)
    -   [54. 输出字符串数组？（题目看不懂）](#输出字符串数组题目看不懂)
    -   [55. 缺失的第一个正数](#缺失的第一个正数)
    -   [56. 场景题：抛硬币问题](#场景题抛硬币问题)
    -   [57. 两个栈实现队列](#两个栈实现队列)
    -   [58. 二叉树右视图](#二叉树右视图)
    -   [59. 概率题：扑克牌](#概率题扑克牌)
    -   [60. 有序有重复数组查找范围](#有序有重复数组查找范围)
    -   [61. 三数之和](#三数之和)
    -   [62. 扫码登录](#扫码登录)
    -   [63. 思考题：赛马](#思考题赛马)
    -   [64. 思考题：抛硬币](#思考题抛硬币)
    -   [65. 三个线程循环打印ABC](#三个线程循环打印abc)
    -   [66. 数组中第K大的数](#数组中第k大的数)
    -   [67. top k](#top-k)
    -   [68. 狼和羊的故事（未解决）](#狼和羊的故事未解决)
    -   [69. 二叉排序树找第k大的元素](#二叉排序树找第k大的元素)
    -   [70. 链表求和](#链表求和-1)
    -   [71. 穿墙术（未解决）](#穿墙术未解决)
    -   [72. 场景题：定时任务](#场景题定时任务)
    -   [73. 二叉树的最近公共祖先 + 搜索二维矩阵 II +
        最长不含重复字符的子字符串](#二叉树的最近公共祖先-搜索二维矩阵-ii-最长不含重复字符的子字符串)
        -   [(1)
            二叉树的最近公共祖先(同题 19)](#二叉树的最近公共祖先同题-19)
        -   [(2) 搜索二维矩阵 II](#搜索二维矩阵-ii)
        -   [(3)
            最长不含重复字符的子字符串](#最长不含重复字符的子字符串)
    -   [73. 场景题：微博关注列表](#场景题微博关注列表)
    -   [74. 场景题：游戏中的 debuff](#场景题游戏中的-debuff)
    -   [75.
        场景题：红黑树，B+树，跳表应用场景](#场景题红黑树b树跳表应用场景)
    -   [76. "马"在棋盘上的概率](#马在棋盘上的概率)
    -   [77. 场景题：大文件中的 id 计算](#场景题大文件中的-id-计算)
    -   [78. 求中位数](#求中位数)
    -   [79. 输出第 n 个字符（未解决）](#输出第-n-个字符未解决)
    -   [80. 公交车超载](#公交车超载)
    -   [81. 全排列](#全排列)
    -   [82. 场景题：台球入洞](#场景题台球入洞)
    -   [83. 完全二叉树的节点个数](#完全二叉树的节点个数)
    -   [84. 链表实现一个栈](#链表实现一个栈)
    -   [85. 加油站 + 柠檬水找零](#加油站-柠檬水找零)
        -   [(1) 加油站](#加油站)
        -   [(2) 柠檬水找零](#柠檬水找零)
    -   [86. 堆](#堆)
    -   [87. 圆圈剩下的数字（约瑟夫环）](#圆圈剩下的数字约瑟夫环)
    -   [88. 和为K的子数组](#和为k的子数组)
    -   [89. 设计模式](#设计模式)
    -   [90. 代码输出](#代码输出)
